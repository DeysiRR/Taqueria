...
drop table sueldos;
select id_sueldo, id_puesto, fecha_pago, monto_sueldo from sueldos;
select * from catalogo_puestos;
delete from sueldos;

update sueldos SET monto_sueldo = 1600 where id_puesto = 2;
UPDATE sueldos SET monto_sueldo = 5020 WHERE id_puesto =  2 ;
